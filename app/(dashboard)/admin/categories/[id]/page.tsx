...
const DashboardSingleCategory = ({
  ...
  useEffect(() => {
    ...
    fetch(`${config.apiURL}/api/categories/${id}`)
      .then((res) => {
        return res.json();
      })
      .then((data) => {
    ...
    <div className="bg-white flex justify-start max-w-screen-2xl mx-auto xl:h-full max-xl:flex-col max-xl:gap-y-5">
      ...
      <div className="flex flex-col gap-y-7 xl:pl-5 max-xl:px-5 w-full">
        ...
        <div className="flex gap-x-2 max-sm:flex-col">
          <button
            type="button"
            className="uppercase bg-gray-500 px-10 py-5 text-lg border border-black border-gray-300 font-bold text-white shadow-sm hover:bg-gray-600 hover:text-white focus:outline-none focus:ring-2"
